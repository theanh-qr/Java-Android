    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer dongho = new CountDownTimer(60000, 300) {
            ...
            public void onTick(long l) {
                ...
                if(s1.getProgress() >= 100){
                    this.cancel();
                    Toast.makeText(MainActivity2.this,"s1 thắng !",Toast.LENGTH_SHORT).show();
                    if(c1.isChecked()){
                        ketqua = ketqua + 10;
                    }else{
                        ketqua = ketqua -5;
                ...
                if(s2.getProgress() >= 100){
                    this.cancel();
                    Toast.makeText(MainActivity2.this,"s2 thắng !",Toast.LENGTH_SHORT).show();
                    if(c2.isChecked()){
                        ketqua = ketqua + 10;
                    }else{
                        ketqua = ketqua -5;
                ...
                if(s3.getProgress() >= 100){
                    this.cancel();
                    Toast.makeText(MainActivity2.this,"s3 thắng !",Toast.LENGTH_SHORT).show();
                    if(c3.isChecked()){
                        ketqua = ketqua + 10;
                    }else{
                        ketqua = ketqua -5;
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ketqua == 0) {
                    Toast.makeText(MainActivity2.this,"Bạn đã hết điểm chơi",Toast.LENGTH_SHORT).show();
                } else if(ketqua <= 0){
                    Toast.makeText(MainActivity2.this,"Bạn đã hết điểm chơi và bị "+ketqua+" điểm",Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (c1.isChecked() || c2.isChecked() || c3.isChecked()) {
                        ...
                        Toast.makeText(MainActivity2.this, "Vui lòng đặt cược", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
